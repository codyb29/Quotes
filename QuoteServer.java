...
public class QuoteServer {
    ...
    public void searchDatabase (String query, int mode) {
        ...
        recentSearches.push (query);
        System.out.println("recentSearches size: " + recentSearches.size ());

        QuoteList results = database.search(query, mode); // given mode
        System.out.print("\n");
  ...
  public static boolean quoteValidation(String quote) {
    ...
    public static void writeToXML(String author, String quote) {
        try {
